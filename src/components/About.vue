...
const initTitleAnimation = ():void => {
    ...
    '-=0.5' // Medio segundo antes de que la animacion previa termine. Esto hara que las animaciones se solapen un poco, creando una transicion mas fluida entre ellas.
    )
}
